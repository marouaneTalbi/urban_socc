...
<body >
      ...
      <div class="" style="background-image: url('./assets/images/stars.jpg');" id="hh">
      <h1>bonour</h1>
      </div>
      ...
      <div class="p-1 bg-danger"id="home" >
          <main class="" >
                  <div>
                      <div class="row" id="titre">
                          <div class="p-0 col-6 text-center mt-0  text-white">
                              <h1 id="pop" style="font-family: Georgia, serif; font-size:170px" >
                              URBAN
                              <p class="text-white d-inline">SOCCER</p>
                              </h1>
                          </div>
                          <div class=" col-5 mt-5 text-center" id="divRes">
                            <div class="card">
            ...
            <div  id="test">
                              <h1 id="op">RESERVER MAINTENANT</h1>
              </div>
...
<div class=" container bg-dark" style="height:500px; margin-top:250px">
    <div class="row offset-1 ">
        ...
        <div class=" col-3 mt-5 ">
              ...
              <p class="text-white p-2 col-6 text-center border border-light offset-1 mt-5"></p>
        </div>

        <div class=" col-3 mt-5">
              <img src="./assets/images/por.jpg" alt="" style="width:190px">
              <p class="text-white col-5 p-2 text-center border border-light offset-1 mt-5"></p>
        ...
        <div class=" col-2 mt-5">
              ...
              <p class="text-white col-9 p-2 text-center border border-light  offset-1 mt-5"></p>
